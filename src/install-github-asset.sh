...
run() {
   ...
   if [ ! -f "${PLATFORM_CACHE_DIR}/${TOOL_NAME}/${TOOL_VERSION}/${TOOL_NAME}-${TOOL_VERSION}/${TOOL_NAME}" ]; then
       ensure_source 
       download_binary;
       move_binary;
   fi
...
move_binary() {
   ...
   ls -la ${PLATFORM_CACHE_DIR}/${TOOL_NAME}/${TOOL_VERSION}/${TOOL_NAME}-${TOOL_VERSION}/bin/${TOOL_NAME}
